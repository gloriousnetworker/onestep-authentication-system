...
import PasscodeSetupPage from './pages/PasscodePage';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/passcode" element={<PasscodePage showNotification={showNotification} />} />
        <Route path="/biometrics-setup" element={<BiometricsSetupPage showNotification={showNotification} />} />
