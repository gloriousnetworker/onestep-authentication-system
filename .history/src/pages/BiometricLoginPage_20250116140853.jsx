...
const BiometricsLoginPage = () => {
  ...
  />
        ...
        <button className="absolute top-12 right-0 translate-x-1/2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-6 py-2 -mr-48 rounded-full mt-84 hidden sm:block">
          Recovery Center
        </button>
      </div>
