...
const OTPVerificationSignupPage = () => {
  ...
  const handleResendOtp = () => {
    ...
    showNotification(
      `Your new OTP is ${newOtp}. Please input your new OTP in the box below.`,
      "info"
    );
  ...
  const handleProceed = () => {
    ...
    setTimeout(() => {
      if (enteredOtp === storedOtp && timer > 0) {
        ...
        showNotification(
          "OTP verified successfully! Redirecting to Account Setup Page...",
          "success"
        );
...
export default OTPVerificationSignupPage;
