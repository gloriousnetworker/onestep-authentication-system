...
<div className="text-center text-gray-200 font-semibold mb-2 mt-8 font-serif">
  USE ONESTEP ID TO LOGIN
        ...
        <div className="flex justify-center items-center mb-6 mt-8 cursor-pointer relative">
  {/* Text on top of the image */}
  <div className="absolute top-0 text-center text-gray-200 font-semibold mb-2">
