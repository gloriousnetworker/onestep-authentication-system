...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      {/* Profile Section */}
<div className="absolute top-4 left-4 sm:top-6 sm:left-6 lg:top-8 lg:left-8 flex items-center gap-2">
  <img
    src="/avatar.avif"
    alt="User avatar"
    className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full object-cover cursor-pointer"
  ...
  <div className="text-white">
    <h2
      ...
      onClick={toggleDropdown}
    >
      Anna <FaChevronDown className="text-xs sm:text-sm lg:text-base" />
    </h2>
