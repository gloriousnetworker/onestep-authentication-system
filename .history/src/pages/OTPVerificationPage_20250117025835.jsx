...
const OTPVerificationPage = () => {
  ...
  const [timer, setTimer] = useState(600); // 10-minute countdown timer
  ...
  const handleProceed = () => {
    ...
    // Simulate a delay for redirecting to the dashboard
    setTimeout(() => {
      ...
      setIsLoading(false); // Hide loading state after process is complete
    }, 1500); // Delay of 1.5 seconds to simulate server response
  };
    ...
    >
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-12 sm:mt-24 mx-auto px-4 py-6">
        ...
        <button
          ...
          disabled={isLoading}
        >
          {isLoading ? "Redirecting to Dashboard . . . " : "PROCEED"}
        </button>
