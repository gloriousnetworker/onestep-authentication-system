...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      {/* Profile Section */}
      <div className="absolute top-4 left-4 sm:left-8 flex items-center gap-2 relative">
        <img
          src="/avatar.avif"
          alt="User avatar"
        ...
        {dropdownOpen && (
          <div className="absolute top-20 left-0 bg-white text-black shadow-lg rounded-lg w-48">
            <ul className="flex flex-col">
              <li
                className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                onClick={() => handleDropdownOption("/view-profile")}
              >
                View Profile
              </li>
              <li
              ...
              <li
                className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                onClick={() => handleDropdownOption("/biometric-setup")}
              >
                Biometric Setup
              </li>
              <li
                className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                onClick={() => handleDropdownOption("/update-profile-picture")}
              >
