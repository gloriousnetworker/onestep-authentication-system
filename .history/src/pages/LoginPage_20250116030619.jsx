...
const LoginPage = () => {
  ...
  return (
    <div className="relative bg-cover bg-center min-h-screen flex flex-col justify-between" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      {/* Center Login Card */}
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-lg shadow-lg w-[90%] max-w-[900px] h-auto lg:h-[calc(95%+20px)] flex flex-col justify-between mt-32 mx-auto px-4 py-6">
  ...
  <div className="flex justify-end w-full mt-4 -ml-48 sm:-ml-40 md:-ml-32 lg:-ml-48 xl:-ml-92
  "> {/* Adjusted margins for different screen sizes */}
  <span className="text-yellow-500 underline">Recovery Center</span>
      ...
      {/* Footer Text */}
      <div className="text-center text-sm text-gray-500 mt-12px">
        <p className="mb-2">
        ...
        <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-40 py-3 rounded w-full sm:w-auto mb-16">
          SIGN UP
        </button>
      </div>
