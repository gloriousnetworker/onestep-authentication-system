...
const BiometricsRegistrationPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-12 sm:mt-24 mx-auto px-4 py-6 ml-8">
        {/* Header */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-8 mb-6">
          ...
          <div className="text-center">
            ...
            <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold py-2 px-6 rounded mt-4 text-sm sm:text-base">
              SETUP TOUCH ID
            </button>
          </div>
