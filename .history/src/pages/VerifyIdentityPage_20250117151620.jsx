      ...
      <div className="w-full max-w-[900px] mx-auto px-6 py-8 bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg relative">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4">
            <button className="w-full sm:w-auto bg-white text-black border border-gray-600 rounded px-6 py-2 hover:bg-gray-200 focus:outline-none">
              Previous
            </button>
            <button
              type="submit"
              className="w-full sm:w-auto bg-yellow-500 text-white border border-yellow-500 rounded px-6 py-2 hover:bg-yellow-400 focus:outline-none"
            >
              Next
            </button>
          </div>
