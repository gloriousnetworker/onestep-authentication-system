...
<div className="text-center text-sm text-gray-500">
          ...
          <button class="bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 bg-clip-text text-transparent font-semibold py-3 px-6 rounded-full shadow-md hover:bg-gradient-to-r hover:from-yellow-400 hover:to-yellow-500 transition duration-300 w-full sm:w-auto">
  SIGN UP
</button>
