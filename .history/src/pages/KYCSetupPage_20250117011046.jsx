...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
  ...
  <div className="relative">
    ...
    />
    <label
      className="absolute left-3 top-2.5 text-gray-400 text-xs transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-600 peer-focus:top-2.5 peer-focus:text-xs peer-focus:text-blue-500"
    >
      FIRST NAME
    </label>
  </div>
