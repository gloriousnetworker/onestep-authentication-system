...
const LoginPage = () => {
  ...
  return (
    <div className="relative bg-cover bg-center min-h-screen flex items-center justify-center" style={{ backgroundImage: "url('/path/to/your-background.jpg')" }}>
      {/* Top Left: Create Account */}
      <div className="absolute top-4 left-4 flex items-center gap-2">
        <div className="w-10 h-10 bg-gray-300 rounded-full"></div> {/* Profile Image Placeholder */}
