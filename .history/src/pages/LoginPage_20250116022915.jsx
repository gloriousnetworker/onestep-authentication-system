...
const LoginPage = () => {
  ...
  return (
    <div className="relative bg-cover bg-center min-h-screen flex flex-col justify-between" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      {/* Center Login Card */}
      <div className="bg-black bg-opacity-90 border border-white rounded-lg shadow-lg w-[95%] max-w-[500px] h-auto lg:h-[95%] flex flex-col justify-between mt-32 mx-auto px-4 py-8">
        {/* Login Card Contents */}
