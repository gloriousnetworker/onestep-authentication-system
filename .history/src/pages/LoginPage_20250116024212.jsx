...
const LoginPage = () => {
  ...
  return (
    <div className="relative bg-cover bg-center min-h-screen flex flex-col justify-between" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      {/* Center Login Card */}
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-lg shadow-lg w-[90%] max-w-[600px] h-auto lg:h-[calc(95%+60px)] flex flex-col justify-between mt-32 mx-auto px-4 py-6">
