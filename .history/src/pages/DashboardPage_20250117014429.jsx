        ...
        <div className="flex justify-center items-start gap-12 mb-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-400 text-xs">Enter Account Information</p>
            </div>
          </div>
          <div className="flex items-center">
            <div className="bg-gray-300 text-black font-semibold w-8 h-8 flex justify-center items-center rounded-full">
            ...
            <div className="ml-4">
              <h2 className="text-gray-200 text-sm font-bold">Passcode Setup</h2>
              <p className="text-gray-400 text-xs">Set up your passcode</p>
            </div>
          </div>
          <div className="flex items-center">
            <div className="bg-gray-300 text-black font-semibold w-8 h-8 flex justify-center items-center rounded-full">
            ...
            <div className="ml-4">
              <h2 className="text-gray-200 text-sm font-bold">Biometric Setup</h2>
              <p className="text-gray-400 text-xs">Configure biometrics</p>
            </div>
          </div>
          <div className="flex items-center">
            <div className="bg-gray-300 text-black font-semibold w-8 h-8 flex justify-center items-center rounded-full">
            ...
            <div className="ml-4">
              <h2 className="text-gray-200 text-sm font-bold">KYC/AML Verification</h2>
              <p className="text-gray-400 text-xs">Verify your identity</p>
            </div>
          </div>
        </div>
