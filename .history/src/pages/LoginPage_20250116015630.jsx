...
<div className="text-center text-sm text-gray-500">
  <p className="mb-2 bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 bg-clip-text text-transparent">
    By using Login, you agree to our{" "}
    <span className="underline cursor-pointer bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 bg-clip-text text-transparent">
