    ...
    >
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-12 sm:mt-24 mx-auto px-4 py-6 relative">
        ...
        <div className="flex justify-center gap-8 mb-6">
          {/* Touch ID Card */}
          <div className="bg-gray-800 text-white w-64 h-36 flex flex-col items-center justify-center rounded-lg shadow-md">
            <img src="/fingerprint.png" alt="Touch ID" className="w-12 h-12 mb-2" loading="lazy" />
