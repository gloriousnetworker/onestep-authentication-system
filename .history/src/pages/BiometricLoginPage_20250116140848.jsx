...
const BiometricsLoginPage = () => {
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-12 sm:mt-24 mx-auto px-4 py-6 relative">
        ...
        <div className="flex justify-center gap-8 mb-6">
          ...
          <div className="bg-gray-800 text-white w-32 h-36 flex flex-col items-center justify-center rounded-lg shadow-md">
            <img src="/fingerprint.png" alt="Touch ID" className="w-32 h-24 mb-2" loading="lazy" />
            <span className="text-sm">Touch ID</span>
          </div>

          {/* Face ID Card */}
          <div className="bg-gray-800 text-white w-32 h-36 flex flex-col items-center justify-center rounded-lg shadow-md">
            <img src="/faceID.png" alt="Face ID" className="w-18 h-24 mb-2" loading="lazy" />
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="flex-1 flex flex-col items-center border-r border-gray-600 pr-4">
            ...
            <h3 className="text-gray-400 mt-12">Kindly select a Messenger</h3>
          ...
          {/* Right Section: Onestep Biometrics */}
  ...
  />
            ...
            <button className="bg-[#7c3aed] hover:bg-purple-700 text-white font-semibold px-12 py-2 rounded mt-4 mb-2">
              Onestep Passcode
            </button>
            <p className="text-gray-400 mb-2">Having Trouble using Biometric Verification?</p>
            <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-20 py-2 rounded">
              HELP CENTRE
            </button>
          </div>
        ...
        <button className="absolute top-12 right-0 translate-x-1/2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-6 py-2 -mr-48 rounded-full mt-92 hidden sm:block">
          Recovery Center
        </button>
      </div>
