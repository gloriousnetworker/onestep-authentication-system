...
<div className="absolute top-4 left-1/2 transform -translate-x-1/2">
  <img src="/onestep.png" alt="Logo" className="w-25 h-6" /> {/* Logo Image */}
      ...
      <div className="bg-black bg-opacity-90 border border-white rounded-lg shadow-lg p-8 w-[90%] max-w-md">
        {/* Login Card Contents */}
<h1 className="text-white text-3xl font-bold mb-4 text-center font-serif">Login</h1>
...
<div className="text-center text-gray-200 font-semibold mb-2 mt-9 font-serif">
