    ...
    >
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-32 mx-auto px-4 py-6">
        ...
        <div className="text-center text-gray-400 mb-4">
          ...
          <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-48 sm:px-20 lg:px-48 py-2 rounded">
            HELP CENTRE
          </button>
        </div>
      </div>
      ...
      <div className="text-center text-sm text-gray-500 mt-auto">
        ...
        <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-48 py-3 mb-4 rounded w-auto">
          SIGN UP
        </button>
      </div>
    </div>
