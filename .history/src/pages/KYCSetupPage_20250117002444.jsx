...
const KYCAmlSetupPage = () => {
  ...
  return (
    ...
    >
      {/* Step Circles */}
      <div className="absolute top-1/2 left-[calc(100%+10px)] transform -translate-y-1/2 flex flex-col gap-4">
        <div className="flex flex-col items-center">
          {/* Step Circle 1 */}
          <div className="w-8 h-8 rounded-full border-2 border-yellow-500 flex items-center justify-center text-white font-semibold">
            1
          </div>
          <p className="text-xs text-white">Personal Information</p>
        </div>

        <div className="flex flex-col items-center">
          {/* Step Circle 2 */}
          <div className="w-8 h-8 rounded-full border-2 border-gray-500 bg-gray-500 flex items-center justify-center text-white font-semibold">
            2
          </div>
          <p className="text-xs text-white">Verify your Identity</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-xs text-white">Photo Selfie with ID</p>
        </div>
      </div>
      ...
      <div className="w-full max-w-[900px] mx-auto px-6 py-8 bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg relative">
        {/* Back Button (Positioned just above the card) */}
        <div
          className="absolute top-0 left-0 text-white text-sm flex items-center gap-2 cursor-pointer mb-6"
          onClick={() => navigate(-1)}
        >
          <span className="text-lg">{"<"}</span>
          <span>Back</span>
