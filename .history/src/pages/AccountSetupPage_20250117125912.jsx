...
const AccountSetupPage = () => {
  ...
  const handleSubmit = () => {
    if (handleValidation()) {
      ...
      setButtonText("Redirecting to Onestep Passcode...");
      setTimeout(() => {
        navigate("/passcode");
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={() => navigate("/otp-verification-signup")}
      >
      ...
      <div className="bg-black bg-opacity-90 border border-white border-opacity-20 rounded-xl shadow-lg w-[90%] max-w-[900px] flex flex-col justify-between mt-12 sm:mt-24 mx-auto px-4 py-6">
        ...
        {/* Proceed Button */}
      <button
        className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold w-full py-2 rounded mb-4"
        onClick={handleSubmit}
        disabled={buttonText !== "PROCEED"} // Disable button once clicked
      >
        {buttonText}
      </button>
