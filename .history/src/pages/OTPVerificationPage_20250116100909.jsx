        ...
        <div className="flex justify-center gap-2 mb-6">
          {otp.map((digit, index) => (
            <input
              ...
              className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-800 text-white text-center text-lg font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ))}
        </div>
