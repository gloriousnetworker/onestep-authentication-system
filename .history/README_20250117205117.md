...
Key Features
Social Login Integration: Use Telegram for seamless account sign-in and sign-up.
Passcode Creation: Users create unique, secure passcodes validated by the AVV system.
Biometric Authentication: Enable FaceID or TouchID authentication via WebAuthn.
Device Management: Register up to 5 devices for account access control.
